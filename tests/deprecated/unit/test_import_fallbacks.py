...
class TestOptionalDependency:
    ...
    def test_failed_import_silent(self, caplog):
        ...
        with caplog.at_level(logging.WARNING):
            with OptionalDependency(
                "nonexistent_module", "test feature", silent=True
            ) as dep:
                raise ImportError("Module not found")
...
class TestSafeImport:
    ...
    def test_failed_import_with_fallback(self, caplog):
        ...
        with caplog.at_level(logging.WARNING):
            module, available = safe_import(
                "nonexistent_module", "Test Module", "test feature", fallback_value
            )
    ...
    def test_failed_import_silent(self, caplog):
        ...
        with caplog.at_level(logging.WARNING):
            module, available = safe_import("nonexistent_module", silent=True)
