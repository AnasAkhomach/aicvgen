...
class TestJobDescriptionParserAgentDIContainer:
    ...
    def test_container_provides_llm_cv_parser_service(self, container):
        ...
        with patch('src.services.llm_cv_parser_service.LLMCVParserService.__init__', return_value=None):
    ...
    def test_container_provides_job_description_parser_agent_with_di(self, container):
        ...
        with patch('src.services.llm_cv_parser_service.LLMCVParserService.__init__', return_value=None), \
             patch('src.agents.job_description_parser_agent.JobDescriptionParserAgent.__init__', return_value=None) as mock_init:
    ...
    def test_container_dependency_injection_flow(self, container):
        ...
        with patch('src.config.settings.get_config') as mock_config, \
             patch('src.templates.content_templates.ContentTemplateManager.__init__', return_value=None), \
             patch('src.services.llm_service.EnhancedLLMService.__init__', return_value=None), \
             patch('src.services.llm_cv_parser_service.LLMCVParserService.__init__', return_value=None) as mock_parser_init, \
             patch('src.agents.job_description_parser_agent.JobDescriptionParserAgent.__init__', return_value=None) as mock_agent_init:
            
            # Configure mock config
            mock_config.return_value = Mock()
            mock_config.return_value.agent_settings.model_dump.return_value = {"test": "settings"}
    ...
    def test_container_agent_factory_behavior(self, container):
        ...
        with patch('src.services.llm_cv_parser_service.LLMCVParserService.__init__', return_value=None), \
             patch('src.agents.job_description_parser_agent.JobDescriptionParserAgent.__init__', return_value=None):
