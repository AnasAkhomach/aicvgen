...
class TestAD002FixIntegration:
    ...
    def test_executive_summary_writer_input_extraction(self):
        ...
        expected_fields = {"session_id", "structured_cv", "job_description_data", "research_findings"}
        assert set(inputs.keys()) == expected_fields
    ...
    async def test_cv_analyzer_agent_run_as_node_integration(self):
        ...
        with patch('src.agents.cv_analyzer_agent.CVAnalyzerAgent._execute') as mock_execute:
    ...
    def test_input_mapping_reduces_coupling(self):
        ...
        expected_exec_fields = {"session_id", "structured_cv", "job_description_data", "research_findings"}
        ...
        state_only_fields = {"trace_id", "current_section_key", "current_section_index", 
                           "items_to_process_queue", "current_item_id", "is_initial_generation",
                           "content_generation_queue", "error_messages"}
    ...
    def test_agent_input_models_are_type_safe(self):
        ...
        from src.models.agent_input_models import CVAnalyzerAgentInput, ExecutiveSummaryWriterAgentInput
        ...
        assert validated_cv_input.job_description is not None  # Should contain job description data
