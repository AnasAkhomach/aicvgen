...
class TestLLMClientInterfaceIntegration:
    ...
    def test_container_provides_llm_client_interface(self, container):
        ...
        # Act & Assert
        with patch('src.services.llm.gemini_client.GeminiClient.__init__', return_value=None):
    ...
    def test_llm_api_key_manager_uses_interface(self, container):
        ...
        # Act & Assert
        with patch('src.services.llm.gemini_client.GeminiClient.__init__', return_value=None), \
             patch('src.services.llm_api_key_manager.LLMApiKeyManager.__init__', return_value=None) as mock_init:
    ...
    def test_llm_retry_handler_uses_interface(self, container):
        ...
        # Act & Assert
        with patch('src.services.llm.gemini_client.GeminiClient.__init__', return_value=None), \
             patch('src.services.llm_retry_handler.LLMRetryHandler.__init__', return_value=None) as mock_init:
