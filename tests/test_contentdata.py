...
class TestContentData(unittest.TestCase):
    ...
    def test_structured_cv_to_content_data(self):
        ...
        skills_section.items.append(Item(
            content="Python",
            status=ItemStatus.GENERATED,
        ...
        role1.metadata = {"company": "ABC Inc", "location": "New York", "period": "2020-2022"}
        role1.items.append(Item(
        ...
        project1.metadata = {"technologies": ["Python", "React"], "description": "Project description"}
        ...
        edu1.metadata = {"institution": "University X", "location": "Boston", "period": "2018-2020"}
        edu1.items.append(Item(
            content="GPA: 3.9",
            status=ItemStatus.GENERATED,
            item_type=ItemType.BULLET_POINT
        ))
        ...
        cert_section.items.append(Item(
        ...
        lang_section.items.append(Item(
        ...
        self.assertEqual(content_data["summary"], "Experienced software developer with expertise in Python and JavaScript.")
        ...
        self.assertEqual(content_data["certifications"][0]["name"], "AWS Certified Developer")
        ...
        self.assertTrue(
            language_name == "English" or 
            language_name == "**English**" or 
            language_name == "*English*" or
            language_name == "*English",  # Single asterisk without closing
        ...
        self.assertTrue(
            language_name == "Spanish" or 
            language_name == "**Spanish**" or 
            language_name == "*Spanish*" or
            language_name == "*Spanish",  # Single asterisk without closing
