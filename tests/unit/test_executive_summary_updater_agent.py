...
class TestExecutiveSummaryUpdaterAgent:
    ...
    def updater_agent(self):
        ...
        return ExecutiveSummaryUpdaterAgent(
            ...
            name="test_executive_summary_updater"
        )
    ...
    def test_input_validation_missing_structured_cv(self, updater_agent, generated_summary_data):
    ...
    def test_input_validation_missing_generated_data(self, updater_agent, mock_structured_cv):
        ...
        with pytest.raises(AgentExecutionError, match="Missing required input: generated_executive_summary"):
            updater_agent._validate_inputs(invalid_input_dict)
    ...
    def test_input_validation_empty_generated_data(self, updater_agent, mock_structured_cv):
        ...
        with pytest.raises(AgentExecutionError, match="generated_executive_summary cannot be empty"):
            updater_agent._validate_inputs(invalid_input_dict)
    ...
    @pytest.mark.asyncio
    async def test_execute_without_existing_section(self, updater_agent, generated_summary_data):
    ...
    @pytest.mark.asyncio
    async def test_section_placement_at_beginning(self, updater_agent, generated_summary_data):
