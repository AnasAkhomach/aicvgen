...
class TestFormatterAgent:
    ...
    def formatter_agent(self):
        ...
        return FormatterAgent(name="TestFormatter", description="Test formatter agent")
        ...
        cv.sections = [
            ...
            Section(
                ...
                items=[
                    ...
                    Item(
                        content="Managed team of 5 developers and improved deployment efficiency by 40%",
                        status=ItemStatus.GENERATED,
                    ),
                ],
            ),
            Section(
                ...
                items=[
                    Item(
                        content="Programming Languages: Python, JavaScript, TypeScript, Java",
                        status=ItemStatus.GENERATED,
                    ),
                    Item(
                        content="Frameworks: React, Django, Flask, Spring Boot",
                        status=ItemStatus.GENERATED,
                    ),
                    Item(
                        content="Cloud Platforms: AWS, Azure, Docker, Kubernetes",
                        status=ItemStatus.GENERATED,
                    ),
                ],
            ),
            Section(
                ...
                items=[
                    Item(
                        content="Master of Science in Computer Science, MIT (2018-2020)",
                        status=ItemStatus.GENERATED,
                    ),
                    Item(
                        content="Bachelor of Science in Software Engineering, Stanford (2014-2018)",
                        status=ItemStatus.GENERATED,
                    ),
                ],
            ),
    ...
    def test_formatter_agent_initialization(self):
        ...
        agent = FormatterAgent(name="TestFormatter", description="Test description")
    ...
    async def test_run_success(self, formatter_agent, sample_content_data):
        ...
        with patch.object(formatter_agent, "_generate_pdf") as mock_pdf, patch.object(
            formatter_agent, "_validate_output"
        ) as mock_validate:
    ...
    async def test_run_missing_structured_cv(self, formatter_agent):
        ...
        content_data = {"format_type": "pdf", "template_name": "professional"}
    ...
    async def test_run_as_node_missing_content_data(
        self, formatter_agent, sample_structured_cv
    ):
    ...
    async def test_run_as_node_formatting_error(
        ...
        with patch.object(formatter_agent, "run") as mock_run:
            ...
            assert len(result_state.error_messages) == 1
            assert (
                "Error during formatting: PDF generation failed"
    ...
    def test_generate_pdf_success(
        self, mock_weasyprint, formatter_agent, sample_structured_cv
    ):
        ...
        with patch.object(formatter_agent, "_generate_html") as mock_html_gen:
            ...
            output_path = formatter_agent._generate_pdf(
                sample_structured_cv, "professional", "test_output.pdf"
            )
    ...
    @patch("src.agents.formatter_agent.weasyprint")
    def test_generate_pdf_weasyprint_error(
        self, mock_weasyprint, formatter_agent, sample_structured_cv
    ):
    ...
    def test_generate_html_professional_template(
        self, formatter_agent, sample_structured_cv
    ):
        """Test HTML generation with professional template."""
        html_content = formatter_agent._generate_html(
            sample_structured_cv, "professional"
        )
    ...
    def test_generate_html_creative_template(
        self, formatter_agent, sample_structured_cv
    ):
    ...
    def test_generate_html_invalid_template(
        ...
        html_content = formatter_agent._generate_html(
            sample_structured_cv, "invalid_template"
        )
    ...
    def test_generate_html_file_success(
        self, mock_file, formatter_agent, sample_structured_cv
    ):
        """Test HTML file generation."""
        output_path = formatter_agent._generate_html_file(
            sample_structured_cv, "professional", "test_output.html"
        )
    ...
    @patch("builtins.open")
    def test_generate_html_file_write_error(
        self, mock_open_func, formatter_agent, sample_structured_cv
    ):
    ...
    def test_format_section_content(self, formatter_agent):
        ...
        section = Section(
            ...
            items=[
                Item(
                    content="Senior Developer at ABC Corp", status=ItemStatus.GENERATED
                ),
    ...
    def test_apply_template_styling_professional(self, formatter_agent):
        ...
        styled_content = formatter_agent._apply_template_styling(
    ...
    def test_confidence_score_calculation(self, formatter_agent):
        ...
        minimal_output = {"final_output_path": "test.pdf"}
