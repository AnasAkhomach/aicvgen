...
class TestApplicationStartup:
    ...
    def test_validate_application_failure(self, mock_get_startup_manager):
        ...
        self.startup.services["environment"] = ServiceStatus(
            name="environment", initialized=False, initialization_time=0.1, error="Config failed"
        )
        self.startup.services["llm_service"] = ServiceStatus(
            name="llm_service", initialized=False, initialization_time=0.1, error="Service not available"
        )
