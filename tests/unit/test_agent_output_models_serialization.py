...
class TestAgentOutputModelsSerialization:
    ...
    def test_formatter_agent_output_serialization(self):
        ...
        model = FormatterAgentOutput(
            output_path="/path/to/formatted/cv.pdf"
        )
    ...
    def test_research_models_serialization(self):
        ...
        models = [
            company_insight, industry_insight, role_insight, 
            metadata, research_findings, research_output
        ]
        ...
        for model in models:
            ...
            if hasattr(model, 'research_timestamp') and model.research_timestamp:
                assert restored.research_timestamp.isoformat() == model.research_timestamp.isoformat()
            else:
                assert restored.model_dump() == model.model_dump()
    ...
    def test_complex_nested_serialization(self):
        ...
        assert restored.research_findings.industry_insights.industry_name == "Technology"
