...
class TestJobDescriptionParserAgentDI:
    ...
    def test_agent_initialization_with_dependency_injection(
        self, job_description_parser_agent, mock_llm_cv_parser_service
    ):
        ...
        assert (
            job_description_parser_agent.llm_cv_parser_service
            is mock_llm_cv_parser_service
        )
    ...
    async def test_parse_job_description_uses_injected_service(
        ...
        mock_llm_cv_parser_service.parse_job_description_with_llm.return_value = (
            expected_job_data
        )
