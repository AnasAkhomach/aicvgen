...
class TestEnhancedContentWriterRefactored:
    ...
    def test_initialization_with_parser_agent(self):
        ...
        assert self.agent.parser_agent.description == "Parser agent for content writer parsing methods"
    ...
    async def test_generate_big_10_skills_uses_parser_agent(self):
        ...
        self.agent.parser_agent._parse_big_10_skills = Mock(return_value=expected_skills)
        
        # Mock template loading
        with patch.object(self.agent, '_load_prompt_template', return_value="Test template: {main_job_description_raw} {my_talents}"):
        ...
        self.agent.parser_agent._parse_big_10_skills.assert_called_once_with(mock_response.content)
    ...
    async def test_generate_big_10_skills_parser_error_handling(self):
        ...
        self.agent.parser_agent._parse_big_10_skills = Mock(side_effect=Exception("Parser error"))
