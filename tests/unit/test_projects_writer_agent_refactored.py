...
from src.agents.projects_writer_agent import (
    ProjectsWriterAgent,
...
class TestProjectsWriterAgentRefactored:
    ...
    def test_input_model_validation(self, sample_input_data):
        ...
        assert (
            input_model.professional_experience
            == sample_input_data["professional_experience"]
        )
        ...
        assert (
            input_model.format_instructions == sample_input_data["format_instructions"]
        )
