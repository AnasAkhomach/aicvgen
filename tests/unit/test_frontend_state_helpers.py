...
class TestFrontendStateHelpers:
    ...
    def test_initialize_session_state_all_new(self, mock_streamlit):
        ...
        session_id_calls = [call for call in mock_streamlit.__setitem__.call_args_list 
    ...
    def test_initialize_session_state_some_exist(self, mock_streamlit):
        ...
        expected_new_vars = {
            'run_workflow', 'session_token_limit', 'manual_stop', 'session_id',
            'job_description_input', 'cv_text_input', 'start_from_scratch_input'
        }
