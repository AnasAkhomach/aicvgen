...
from src.models.data_models import StructuredCV, Section, Item, ItemStatus, UserFeedback, UserAction
...
class TestWorkflowRouting:
    ...
    @pytest.mark.asyncio
    async def test_route_after_review_accept_feedback_empty_queue_has_next_section(self, base_state):
    ...
    async def test_route_after_review_accept_feedback_no_next_section(self, base_state):
        ...
        base_state.current_section_key = "executive_summary"  # Last section in WORKFLOW_SEQUENCE
        base_state.items_to_process_queue = []
        feedback = UserFeedback(
            item_id="edu_1",
            action=UserAction.ACCEPT,
    ...
    @pytest.mark.asyncio
    async def test_route_after_review_no_feedback_empty_queue_has_next_section(self, base_state):
