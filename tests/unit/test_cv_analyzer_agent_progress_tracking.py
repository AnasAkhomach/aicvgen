...
class TestCVAnalyzerAgentProgressTracking:
    ...
    @pytest.mark.asyncio
    async def test_progress_tracking_calls(self, cv_analyzer_agent, sample_cv_data, sample_job_description):
    ...
    async def test_progress_tracking_without_tracker(self, cv_analyzer_agent, sample_cv_data, sample_job_description):
        ...
        try:
            ...
            assert "progress" not in error_msg and "tracker" not in error_msg, f"Progress tracking error: {e}"
