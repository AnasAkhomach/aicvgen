...
class TestFrontendCallbacks:
    ...
    def test_handle_user_action_accept(self, mock_rerun, mock_success, 
    ...
    @patch('streamlit.rerun')
    def test_handle_user_action_regenerate(self, mock_rerun, mock_info, 
                                         mock_streamlit, sample_agent_state):
    ...
    @patch('streamlit.error')
    def test_handle_user_action_unknown_action(self, mock_error, mock_streamlit, 
                                             sample_agent_state):
    ...
    @patch('streamlit.success')
    @patch('streamlit.rerun')
    def test_multiple_actions_sequence(self, mock_rerun, mock_success, 
                                     mock_streamlit, sample_agent_state):
