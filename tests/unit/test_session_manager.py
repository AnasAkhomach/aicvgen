...
class TestSessionManager:
    ...
    def test_session_state_saving_and_loading(
        self, session_manager, sample_agent_state
    ):
    ...
    def test_session_state_persistence_across_instances(
        self, temp_data_dir, sample_agent_state
    ):
    ...
    def test_save_state_creates_session_directory(
        self, session_manager, sample_agent_state
    ):
