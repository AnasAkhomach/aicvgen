...
class TestRouteAfterReview:
    ...
    async def test_route_with_regenerate_action(self):
        ...
        # Arrange
        from src.models.data_models import UserFeedback, JobDescriptionData, StructuredCV
        
        test_state = {
            "error_messages": [],
            "user_feedback": UserFeedback(action=UserAction.REGENERATE, item_id="test_item", feedback_text="Please regenerate"),
            "items_to_process_queue": ["item1"],
            "current_section_key": "key_qualifications",
            "structured_cv": StructuredCV(),
            "job_description_data": JobDescriptionData(raw_text="test job")
    ...
    async def test_error_priority_over_other_conditions(self):
        ...
        test_state = {
            ...
            "user_feedback": UserFeedback(action=UserAction.REGENERATE, item_id="test_item", feedback_text="Regenerate"),
            "items_to_process_queue": ["item1", "item2"],
            "current_section_key": "key_qualifications",
            "structured_cv": StructuredCV(),
            "job_description_data": JobDescriptionData(raw_text="test job")
