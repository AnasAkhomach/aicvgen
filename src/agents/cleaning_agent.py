...
class CleaningAgent(EnhancedAgentBase):
    ...
    async def run_async(self, input_data: Any, context: AgentExecutionContext) -> AgentResult:
        ...
        try:
            ...
            confidence_score = self._calculate_confidence_score(raw_output, cleaned_data)
    ...
    async def _clean_big_10_skills(self, raw_output: str, context: AgentExecutionContext) -> List[str]:
        ...
        try:
            ...
            for skill in skills:
                ...
                skill = re.sub(r'^(skill:?|ability:?|competency:?)\s*', '', skill, flags=re.IGNORECASE)
                skill = skill.strip('.,;:"\'')
    ...
    async def _clean_content_item(self, raw_output: str, context: AgentExecutionContext) -> str:
    ...
    async def _clean_generic_output(self, raw_output: str, context: AgentExecutionContext) -> str:
    ...
    def _calculate_confidence_score(self, raw_output: str, cleaned_data: Any) -> float:
        ...
        if isinstance(cleaned_data, list):
            ...
            reasonable_skills = sum(1 for skill in cleaned_data 
