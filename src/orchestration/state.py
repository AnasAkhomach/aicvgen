...
class GlobalState(TypedDict):
    ...
    # Entry route decision from entry router node
    entry_route: Optional[str]
    # Next node decision from supervisor node
    next_node: Optional[str]
    # Last executed node for tracking workflow progress
    ...
    # Parsed job description data from JD Parser Agent
    parsed_jd: Optional[Any]
    # Research data from Research Agent
    research_data: Optional[Any]
    # CV analysis results from CV Analysis Agent
    cv_analysis: Optional[Any]
