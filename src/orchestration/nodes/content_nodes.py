...
async def key_qualifications_updater_node(state: 'GlobalState', *, agent: 'KeyQualificationsUpdaterAgent') -> 'GlobalState':
...
async def professional_experience_updater_node(state: 'GlobalState', *, agent: 'ProfessionalExperienceUpdaterAgent') -> 'GlobalState':
...
async def projects_updater_node(state: 'GlobalState', *, agent: 'ProjectsUpdaterAgent') -> 'GlobalState':
...
async def executive_summary_updater_node(state: 'GlobalState', *, agent: 'ExecutiveSummaryUpdaterAgent') -> 'GlobalState':
