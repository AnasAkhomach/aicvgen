...
class AicvgenError(Exception):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.stack_trace = current_trace if current_trace != 'NoneType: None\n' and 'Traceback' in current_trace else None
...
class DataConversionError(AicvgenError):
    ...
    def __init__(self, message: str, source_type: Optional[str] = None, target_type: Optional[str] = None, **kwargs):
        super().__init__(
            message=message,
            category=ErrorCategory.PARSING,
            severity=ErrorSeverity.MEDIUM,
