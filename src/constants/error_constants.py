...
class ErrorConstants:
    ...
    MSG_RATE_LIMIT_EXCEEDED: Final[str] = "Rate limit exceeded for {resource}. Retry after {retry_after} seconds"
    MSG_TIMEOUT_ERROR: Final[str] = "Operation timed out after {timeout} seconds: {operation}"
