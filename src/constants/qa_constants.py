...
class QAConstants:
    ...
    ERROR_WORD_COUNT_LOW: Final[str] = "Word count too low: {actual} words (minimum: {minimum})"
    ERROR_WORD_COUNT_HIGH: Final[str] = "Word count too high: {actual} words (maximum: {maximum})"
    ...
    SUCCESS_SECTION_VALIDATION: Final[str] = "Section '{section_name}' validation passed"
    SUCCESS_OVERALL_VALIDATION: Final[str] = "Overall CV validation completed successfully"