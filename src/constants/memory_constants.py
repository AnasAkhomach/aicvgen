...
class MemoryConstants:
    ...
    MSG_MEMORY_WARNING: Final[str] = "Memory usage is high: {usage_mb}MB ({percentage}%)"
    MSG_MEMORY_CRITICAL: Final[str] = "Critical memory usage: {usage_mb}MB ({percentage}%)"
    MSG_MEMORY_OPTIMIZED: Final[str] = "Memory optimized: freed {freed_mb}MB"
    MSG_GC_TRIGGERED: Final[str] = "Garbage collection triggered: collected {objects} objects"
    MSG_MEMORY_LEAK_DETECTED: Final[str] = "Potential memory leak detected: {growth_mb}MB growth"
