...
class OptionalDependency:
    ...
    def __init__(self, dependency_name: str, feature_description: str = "", 
                 log_level: int = logging.WARNING, silent: bool = False):
        """
...
def safe_import(module_path: str, dependency_name: str = None, 
                feature_description: str = "", fallback_value: Any = None,
                log_level: int = logging.WARNING, silent: bool = False) -> Tuple[Any, bool]:
...
def safe_import_from(module_path: str, import_names: Union[str, list], 
                     dependency_name: str = None, feature_description: str = "",
                     fallback_factory: Callable = None, log_level: int = logging.WARNING,
                     silent: bool = False) -> Tuple[Any, bool]:
