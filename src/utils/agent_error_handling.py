...
from ..models.data_models import ErrorFallbackModel  # Add this import
...
class AgentErrorHandler:
    ...
    def handle_validation_error(
        ...
        # Ensure fallback_data is a Pydantic model
    ...
    def handle_general_error(
        ...
        if fallback_data is None:
            ...
            # If 'error' key is missing, wrap the dict as the error message
    ...
    def create_async_wrapper(func):
        ...
        async def async_wrapper(*args, **kwargs):
            try:
                ...
                # Try to extract state from args if possible
                state = None
                if len(args) > 1:
                    state = args[1]
