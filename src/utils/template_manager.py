...
class TemplateManager:
    ...
    STATIC_SECTIONS = ["contact_info", "education", "certifications", "languages"]
    ...
    def get_all_static_sections(self) -> Dict[str, str]:
        ...
        return {
            name: self.sections.get(name, "")
            for name in self.STATIC_SECTIONS
    ...
    def get_all_dynamic_sections(self) -> Dict[str, str]:
        ...
        return {
            name: self.sections.get(name, "")
            for name in self.DYNAMIC_SECTIONS
            if name in self.sections
        }
