...
class QualityAssuranceAgent(AgentBase):
    ...
    def run(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if check_results["summary"]["total_items"] > 0:
            quality_score = (
                check_results["summary"]["passed_items"] / 
                check_results["summary"]["total_items"]
            ) * 100
    ...
    def _check_item(
        ...
        if item.item_type == ItemType.BULLET_POINT:
            action_verbs = [
                ...
                "developed", "increased", "decreased", "designed", "led",
                "implemented", "built", "coordinated", "negotiated", "launched"
            ]
    ...
    def _check_overall_cv(self, structured_cv: StructuredCV, key_terms: Dict[str, List[str]]) -> List[Dict[str, Any]]:
        """
        ...
        required_sections = ["Executive Summary", "Key Qualifications", "Professional Experience"]
        missing_sections = [
