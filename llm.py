    ...
    def generate_content(self, prompt):
        ...
        try:
            ...
            if "ResourceExhausted" in str(e) or "quota" in str(e).lower() or "429" in str(e):
                ...
                print(f"Rate limit exceeded. Waiting {retry_seconds} seconds before allowing next request.")
                
                # Enforce a longer wait for the next request
                time.sleep(min(retry_seconds, 5))  # Wait at most 5 seconds here, the rate limiter will handle the rest
